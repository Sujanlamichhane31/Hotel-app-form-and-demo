...
import 'package:loginform/model/contributors.dart';
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            ...
            child: Card(color: const Color(0xFFF3F5F7),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 10,),
                  Card(color: const Color(0xFFF3F5F7),
                                  ...
                                  child: Padding(
                                    ...
                                    child:Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(contributor.description, style: TextStyle(
                                          color: Colors.grey,
                                        ),overflow: TextOverflow.ellipsis,
                                          maxLines: 2,),
                                      ],
